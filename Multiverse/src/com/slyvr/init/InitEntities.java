...
public class InitEntities {
    ...
    {
        Entity player = new Entity(0, "ent_player", new Rectangle(0, 0, global.getImageByName("ent_player1").getImage().getWidth(), global.getImageByName("ent_player1").getImage().getHeight()), 100, 5, 45, 1, 0, global.getImageByName("ent_player1"));

...
public class InitEntities {
    ...
    {
        Entity player = new Entity(0, "Player", new Rectangle(0, 0, global.getImageByName("player_jet_right").getImage().getWidth(), global.getImageByName("player_jet_right").getImage().getHeight()), 100, 5, 45, 2, 0, global.getImageByName("player_jet_right"));
